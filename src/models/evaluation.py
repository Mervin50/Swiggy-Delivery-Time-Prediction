...
mlflow.set_tracking_uri("https://dagshub.com/Mervin50/Swiggy-Delivery-Time-Prediction.mlflow")
...
if __name__ == "__main__":
    ...
    # calculate cross validation scores with reduced parallelism (n_jobs=1)
    cv_scores = cross_val_score(model,
                                X_train,
                                y_train,
                                cv=5,
                                scoring="neg_mean_absolute_error",
                                n_jobs=1)  # Reduce parallelism here
